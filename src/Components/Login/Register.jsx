        ...
        <div className="flex flex-col bg-white w-80 rounded-2xl mt-40">
          ...
          <div className="flex flex-col justify-center mt-9 items-center gap-3 ">
            <label className="relative block">
              ...
              <input
                type="email"
                className="flex gap-2 placeholder:text-2xl pl-14 pt-2 placeholder:text-gray-50 placeholder:italic rounded-lg w-72 h-14 items-center bg-[#A0EDF7]"
                placeholder="Email"
              />
            </label>
            <label className="relative block">
            ...
            <Link to="/login" className="no-underline">
              <div className="flex gap-2 rounded-full w-72 h-12 items-center justify-center bg-[#1065B8]">

  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full  h-full">
        <div className="font-display mt-3 ml-4 text-4xl text-white">Search</div>
        <div>
          ...
          <div className="gap-3 flex flex-col mt-9 ml-3 w-88 lg:w-full ">
            <div className="font-display text-4xl text-white">Genre</div>
          ...
          <div className="gap-3 flex flex-col mt-9 ml-3 w-88 lg:w-full ">
            <div className="font-display text-4xl text-white">Momen</div>
          ...
          <div className="gap-3 flex flex-col mb-16 mt-9 ml-3 w-88 lg:w-full ">
            <div className="font-display text-4xl text-white">Instrumen</div>
            <div className="flex overflow-x-auto gap-3 lg:flex lg:overflow-x-auto py-2">

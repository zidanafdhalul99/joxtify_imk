  ...
  return (
    <>
      ...
      <div className="font-display text-white text-2xl h-screen">
        <div className="flex mt-2 justify-between items-center w-screen bg-sky-600 rounded-3xl shadow-xl">
          <div className="text-4xl flex ml-4">Kelompok 2</div>
        ...
        <div className="flex text-3xl mt-12 rounded-lg w-56 h-12 ml-2 pl-1  bg-[#A0EDF7]">
          <Link
            to="/artikel"

  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full h-screen">
        <div className="font-display mt-3 text-4xl text-white ml-4">
          Create Article
        </div>
        <div className="mt-6">
          <div className="font-display text-3xl text-white ml-4">Judul</div>
        ...
        <div className=" flex justify-between px-3 mt-3">
          <div className="flex flex-col ">
            <div className="font-display text-3xl text-white ">Genre</div>
          ...
          <div className="flex flex-col">
            <div className="font-display text-3xl text-white ">Mood/Momen</div>
            <select className="w-40 h-10">
        ...
        <div className="flex flex-col px-3 mt-3">
          <label
            class="block mb-2 text-3xl font-display text-white"
            for="multiple_files"
          >
            Upload files
          </label>
        ...
        <div class="flex justify-center mt-3">
          <div class="mb-3 px-3 w-full ">
            <label className="font-display text-white text-3xl mt-2">
              Content
            </label>
            <textarea
        ...
        <div className="flex font-display text-white text-2xl justify-end mr-3 gap-2">
          <div>
            <button>Cencel</button>
          </div>
          <Link to="/artikel" className="no-underline text-white">
            <div className="flex justify-center items-center rounded-xl w-20 bg-sky-400">
